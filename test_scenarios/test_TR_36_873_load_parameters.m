...
LTE_params.UE_config.mode                   = 4;                        % {1} Single transmit antenna, {4} Closed-loop spatial multiplexing, {5} MU-MIMO
LTE_params.UE_config.nTX                    = 2;                        % number of UE transmit antennas {1,2,4}
LTE_params.UE_config.user_speed             = 20/3.6;                    % the UE speed defines the doppler spread and the time selectivity of the channel[m/s]
...
LTE_params.ChanMod_config.type                  = 'TR 36.873';                  % 'PedA', 'PedB', 'PedBcorr', 'AWGN', 'flat Rayleigh', 'VehA', 'VehB', 'TU', 'RA', 'HT', 'winner_II', 'ePDP', 'TR 36.873'
...
%% Report settings (experimental)
LTE_params.send_report      = false;
LTE_params.sender_address   = 'lnagel@nt.tuwien.ac.at';
LTE_params.receiver_address = 'lnagel@nt.tuwien.ac.at';
LTE_params.report_title     = 'some simulation';
