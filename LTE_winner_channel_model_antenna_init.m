...
if exist('./Winner Channel Model/dipole.m')==0
    error('Please download Winner+ II channel model from http://projects.celtic-initiative.org/winner+/Documents/Publications/WIM2_3D_ant_ver064_220908.zip and extract it into this folder');
end
...
NAz=3*120; %3 degree sampling interval
Az=linspace(-180,180-1/NAz,NAz);
lambda = 3e8/LTE_params.carrier_freq_UP;
spacing = 4;  %in lambda

switch LTE_params.UE_config.nTX
    case 1
...
Az=linspace(-180,180-1/NAz,NAz);
switch LTE_params.BS_config.nRX
    case 1
