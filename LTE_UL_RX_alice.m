function H_test_results=LTE_UL_RX_alice(LTE_params, ChanMod_output, ChanMod, SNR, subframe_i, BS, UE, UE_output, BS_output, y_alice, UE_MCS_and_scheduling_info, bb)
