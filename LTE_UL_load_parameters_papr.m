...
LTE_params.UE_config.user_speed = 50/3.6;            % [m/s]
...
LTE_params.UE_config.perfect_freq_sync = true;      % whether the UE is perfectly synchronized in frequency
LTE_params.UE_config.rfo_correct_method = 'none';   % 'none','subframe', not yet implemented
...
LTE_params.ChanMod_config.type = 'PedB';                                          % 'PedA', 'PedB', 'PedBcorr', 'AWGN', 'flat Rayleigh','VehA','VehB','TU','RA','HT','winner_II', 'ePDP'
