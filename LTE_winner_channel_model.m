...
wimpar.SampleDensity            = LTE_params.speed_of_light/(2*LTE_params.carrier_freq_UP*Channel_Sampling_Time*LTE_params.UE_config.user_speed); 
...
for user_i = 1:LTE_params.nUE
    ...
    channel_out{user_i} = sqrt(LTE_params.UE_config.nTX * LTE_params.BS_config.nRX) * channel_out{user_i} / sqrt(channel_energy);       % channel is normalized to have mean energy Nt*Nr
end
