classdef shadowFadingMapClaussen < handle
    ...
    properties
        ...
        oneMapPerSite = true;
        random_number_stream = []; % stream for the random number generator (in case provided)
    end
    ...
    methods
        ...
        function obj = shadowFadingMapClaussen(...
            ...
            if isempty(varargin)
                ...
                parallel_toolbox_installed = false;%Added
            else
                deactivate_claussen_spatial_correlation = varargin{1};
                parallel_toolbox_installed = varargin{2};%Added
            end

            % Random number generator stream
            obj.random_number_stream = random_number_stream;
            
            % Fill in number of neighbors
            ...
            if ~isempty(obj.random_number_stream)
                a_n_random_matrix = mean + std_a*randn(obj.random_number_stream,N_y,N_x,num_eNodeBs);
                a_n_original_map  = mean + std_a*randn(obj.random_number_stream,N_y,N_x);
            else
            ...
            [offsets_neighbors, R_alpha_sq] = obj.getCorrMatrix;
            ...
            if ~deactivate_claussen_spatial_correlation
                ...
                eNodeBs_per_lab = ceil(num_eNodeBs/number_of_labs);
        ...
        % Correlation matrix
        function [offsets_neighbors, R_alpha_sq] = getCorrMatrix(obj)
            switch obj.n_neighbors
                case 4
                    offsets_neighbors = [
                        -1  -1
                        -0  -1
