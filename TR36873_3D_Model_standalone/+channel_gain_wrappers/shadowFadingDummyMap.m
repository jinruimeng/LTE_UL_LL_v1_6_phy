classdef shadowFadingDummyMap < handle
    ...
    methods
        function obj = shadowFadingDummyMap(roi_x,roi_y,number_of_eNodeBs_sectors,varargin)
            %% Initialization
            ...
            obj.roi_x       = roi_x;
            obj.roi_y       = roi_y;
            obj.pathloss    = zeros(obj.N_y,obj.N_x, number_of_eNodeBs_sectors);
        end
