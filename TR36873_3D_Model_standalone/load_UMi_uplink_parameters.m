function config = load_UMi_uplink_parameters(config)
...
config.PerClusterAS_D_LOS = 17;       % Per cluster rms azimuth spread of departure angles [deg]
config.PerClusterAS_A_LOS = 3;      % Per cluster rms azimuth spread of arrival angles [deg]
...
config.zsD_asD_LOS = 0;              % departure ZS vs departure AS
...
config.AS_D_mu_LOS    = 1.75;        % azimuth departure angle spread, mean [log10(deg)]
config.AS_D_sigma_LOS = 0.19;        % azimuth departure angle spread, std [log10(deg)]
config.AS_A_mu_LOS    = 1.20;        % azimuth arrival angle spread, mean [log10(deg)]
config.AS_A_sigma_LOS = 0.43;        % azimuth arrival angle spread, std [log10(deg)]
...
config.cluster_ASD_LOS = 17;
config.cluster_ASA_LOS = 3;
...
config.PerClusterAS_D_NLOS = 22;      % Per cluster rms azimuth spread of departure angles [deg]
config.PerClusterAS_A_NLOS = 10;      % Per cluster rms azimuth spread of arrival angles [deg]
...
config.asA_ds_NLOS = 0;               % arrival AS vs delay spread
config.asA_sf_NLOS = 0;               % arrival AS vs shadowing std
config.asD_sf_NLOS = -0.4;            % departure AS vs shadowing std
...
config.zsD_asD_NLOS = 0.2;            % departure ZS vs departure AS
config.zsA_asD_NLOS = 0;              % arrival ZS vs departure AS
config.zsD_asA_NLOS = 0.5;            % departure ZS vs arrival AS
...
config.AS_D_mu_NLOS    = 1.84;        % azimuth departure angle spread, mean [log10(deg)]
config.AS_D_sigma_NLOS = 0.15;        % azimuth departure angle spread, std [log10(deg)]
config.AS_A_mu_NLOS    = 1.41;        % azimuth arrival angle spread, mean [log10(deg)]
config.AS_A_sigma_NLOS = 0.17;        % azimuth arrival angle spread, std [log10(deg)]
...
config.AS_D_lambda_NLOS = 9;          % [m], departure azimuth spread
config.AS_A_lambda_NLOS = 10;         % [m], arrival azimuth spread
...
% CLuster angle spread value
config.cluster_ASD_NLOS = 22;
config.cluster_ASA_NLOS = 10;
