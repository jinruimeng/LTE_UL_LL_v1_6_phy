...
% subcarrier
% % Load all results files from results folder
foldername = './results/calibration';
...
% According to 3GPP R1-140092: Additional details on calibration
% assumptions
H = sum(H_all,3)/6;
H=permute(H, [1 2 4 3]);
