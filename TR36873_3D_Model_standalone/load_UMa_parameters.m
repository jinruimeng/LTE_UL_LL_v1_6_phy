function config = load_UMa_parameters(config)
...
config.PerClusterAS_D_LOS = 5;       % Per cluster rms azimuth spread of departure angles [deg]
config.PerClusterAS_A_LOS = 11;      % Per cluster rms azimuth spread of arrival angles [deg]
...
config.asD_ds_LOS = 0.4;             % departure AS vs delay spread
...
config.asD_kf_LOS = 0;               % departure AS vs k-factor
config.asA_kf_LOS = -0.2;            % arrival AS vs k-factor
...
config.zsA_sf_LOS = -0.8;            % arrival ZS vs shadowing std
config.zsD_kf_LOS = 0;               % departure ZS vs k-factor
config.zsA_kf_LOS = 0;               % arrival ZS vs k-factor
config.zsD_ds_LOS  = -0.2;           % departure ZS vs delay spread
config.zsA_ds_LOS = 0;               % arrival ZS vs delay spread
config.zsD_asD_LOS = 0.5;            % departure ZS vs departure AS
config.zsA_asD_LOS = 0;              % arrival ZS vs departure AS
config.zsD_asA_LOS = -0.3;           % departure ZS vs arrival AS
config.zsA_asA_LOS = 0.4;            % arrival ZS vs arrival AS
...
config.AS_D_mu_LOS    = 1.15;        % azimuth departure angle spread, mean [log10(deg)]
config.AS_D_sigma_LOS = 0.28;        % azimuth departure angle spread, std [log10(deg)]
config.AS_A_mu_LOS    = 1.81;        % azimuth arrival angle spread, mean [log10(deg)]
config.AS_A_sigma_LOS = 0.2;        % azimuth arrival angle spread, std [log10(deg)]
...
config.AS_D_lambda_LOS = 18;         % [m], departure azimuth spread
config.AS_A_lambda_LOS = 15;         % [m], arrival azimuth spread
...
config.cluster_ASD_LOS = 5;
config.cluster_ASA_LOS = 11;
...
config.PerClusterAS_D_NLOS = 2;       % Per cluster rms azimuth spread of departure angles [deg]
config.PerClusterAS_A_NLOS = 15;      % Per cluster rms azimuth spread of arrival angles [deg]
...
% Cross correlation coefficients for azimuth case
config.asD_ds_NLOS = 0.4;             % departure AS vs delay spread
config.asA_ds_NLOS = 0.6;             % arrival AS vs delay spread
config.asA_sf_NLOS = 0;            % arrival AS vs shadowing std
config.asD_sf_NLOS = -0.6;            % departure AS vs shadowing std
...
config.zsA_sf_NLOS = -0.4;            % arrival ZS vs shadowing std
...
config.zsA_asD_NLOS = -0.1;           % arrival ZS vs departure AS
config.zsD_asA_NLOS = 0;              % departure ZS vs arrival AS
config.zsA_asA_NLOS = 0;              % arrival ZS vs arrival AS
...
config.AS_D_sigma_NLOS = 0.28;        % azimuth departure angle spread, std [log10(deg)]
config.AS_A_mu_NLOS    = 1.87;        % azimuth arrival angle spread, mean [log10(deg)]
config.AS_A_sigma_NLOS = 0.11;        % azimuth arrival angle spread, std [log10(deg)]
...
% CLuster angle spread value
config.cluster_ASD_NLOS = 2;
config.cluster_ASA_NLOS = 15;
