function [PDCCHmapping,UsedElements,NElements] = LTE_common_gen_PDCCH(Nrb,Nsc,Nsub,Ns,bandwidth,NoData,PCFICHmapping,PHICHmapping)
...
PDCCHmapping(:,1:nsyms) = xor(xor(xor(PDCCHmapping(:,1:nsyms),NoData(:,1:nsyms)),PCFICHmapping(:,1:nsyms)),PHICHmapping(:,1:nsyms));
